...
<div class="container">
    <form action="EditBookServlet" method="post">
        ...
        <input type="text" id="bookTitle" name="bookTitle" value="<%=book.getTitle()%>" required>

        <label for="bookAuthor">Book Author:</label>
        <input type="text" id="bookAuthor" name="bookAuthor" value="<%=book.getAuthor()%>" required>

        <label for="bookGenre">Book Genre:</label>
        <input type="text" id="bookGenre" name="bookGenre" value="<%=book.getGenre()%>" required>
